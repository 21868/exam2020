...
class Threads {
    ...
    static class RetCords implements Callable<double[]> {
        final  String appid ="d0ead0108c44273daaf9c196bd8bc247"; //Your openweathermap id.
...
class RunnableDemo implements Runnable {
    private final String appid = "d0ead0108c44273daaf9c196bd8bc247"; //Your openweathermap id.
